...
export function SkillCard({ skill, scopePath, scopeType }: {
  skill: Skill;
  scopePath: string;
    ...
    return (
      <Card id={frontmatter.name} className="border-accent/30">
        <form ref={formRef} action={handleSave}>
          ...
          <input type="hidden" name="filePath" value={skill.filePath} />

          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-mono text-text-dim">editing skill</span>
